...
const EXERCISES = [
  { id:1,  name:'Barbell Bench Press',       name_ar:'ضغط بار علي البنش',       muscle_group:'Chest',     difficulty:'intermediate', equipment:'Barbell, Bench',           tips:'خلي رجليك ثابتين على الارض، قوس بسيط في ضهرك، والقبضة اعرض شوية من الكتفين.' },
  { id:2,  name:'Incline Dumbbell Press',    name_ar:'ضغط دمبل مائل',           muscle_group:'Chest',     difficulty:'intermediate', equipment:'Dumbbells, Incline Bench', tips:'اضبط البنش من 30 لـ45 درجة، حاول تحس بضغط الصدر العلوي وانت بتطلع.' },
  { id:3,  name:'Decline Bench Press',       name_ar:'ضغط بنش نازل',            muscle_group:'Chest',     difficulty:'intermediate', equipment:'Barbell, Decline Bench',   tips:'خلي ضهرك ملصق بالبنش طول الوقت.' },
  ...
  { id:6,  name:'Dumbbell Fly',              name_ar:'فلاي دمبل',               muscle_group:'Chest',     difficulty:'beginner',     equipment:'Dumbbells, Bench',         tips:'خلي كوعك متني شوية واحس بالمط في الصدر وانت نازل.' },
  { id:7,  name:'Chest Dip',                 name_ar:'دبس الصدر',               muscle_group:'Chest',     difficulty:'intermediate', equipment:'Dip Bars',                 tips:'مل جسمك للامام 30 درجة وانزل كويس عشان الصدر يتمد صح.' },
  { id:8,  name:'Pec Deck Machine',          name_ar:'ماكينة بيك ديك',         muscle_group:'Chest',     difficulty:'beginner',     equipment:'Pec Deck',                 tips:'متسرعش في الرجعة واضغط الصدر كويس في اقصى نقطة.' },
  ...
  { id:10, name:'Pull-Up',                   name_ar:'عقلة',                    muscle_group:'Back',      difficulty:'intermediate', equipment:'Pull-Up Bar',              tips:'اتعلق كامل في الاسفل واضغط لوحي كتفك وانت طالع.' },
  ...
  { id:14, name:'Single-Arm Dumbbell Row',   name_ar:'رووينج دمبل احادي',      muscle_group:'Back',      difficulty:'beginner',     equipment:'Dumbbell, Bench',          tips:'المرفق قريب من جسمك ومدى الحركة يكون كامل.' },
  { id:15, name:'T-Bar Row',                 name_ar:'تي بار رووينج',           muscle_group:'Back',      difficulty:'intermediate', equipment:'T-Bar Machine',            tips:'ضهرك موازي للارض وخلي قوس بسيط في اسفل الضهر.' },
  ...
  { id:27, name:'Preacher Curl',             name_ar:'بريتشر كيرل',             muscle_group:'Biceps',    difficulty:'beginner',     equipment:'Barbell, Preacher Bench',  tips:'متمدش المرفق اوي في الاسفل عشان متتاذيش.' },
  { id:28, name:'Incline Dumbbell Curl',     name_ar:'كيرل دمبل مائل',         muscle_group:'Biceps',    difficulty:'intermediate', equipment:'Dumbbells, Incline Bench', tips:'الوضع ده بيمد الرأس الطويل للبايسبس بشكل ممتاز.' },
  ...
  { id:30, name:'Concentration Curl',        name_ar:'كيرل تركيز',              muscle_group:'Biceps',    difficulty:'beginner',     equipment:'Dumbbell',                 tips:'الف معصمك بالكامل في الاعلى وارجع ببطء.' },
  { id:31, name:'Close-Grip Bench Press',    name_ar:'بنش قبضة ضيقة',          muscle_group:'Triceps',   difficulty:'intermediate', equipment:'Barbell, Bench',           tips:'المرفقين لازق بجسمك واليدين بعرض الكتفين.' },
  { id:32, name:'Tricep Dip',                name_ar:'دبس تراسبس',              muscle_group:'Triceps',   difficulty:'intermediate', equipment:'Dip Bars',                 tips:'جسمك عمودي والمرفقين وراك.' },
  { id:33, name:'Skull Crusher',             name_ar:'سكال كراشر',              muscle_group:'Triceps',   difficulty:'intermediate', equipment:'Barbell, Bench',           tips:'الجزء العلوي من دراعك يفضل عمودي طول الوقت.' },
  ...
  { id:35, name:'Overhead Tricep Extension', name_ar:'مط تراسبس فوق الراس',    muscle_group:'Triceps',   difficulty:'beginner',     equipment:'Dumbbell',                 tips:'الرأس الطويل بيتمد كامل فوق الراس، خلي المرفقين قريبين.' },
  ...
  { id:37, name:'Tricep Kickback',           name_ar:'كيك باك تراسبس',         muscle_group:'Triceps',   difficulty:'beginner',     equipment:'Dumbbell',                 tips:'مد الدراع بالكامل عشان التراسبس ينقبض صح.' },
  { id:38, name:'Barbell Squat',             name_ar:'سكوات بار',               muscle_group:'Legs',      difficulty:'advanced',     equipment:'Barbell, Squat Rack',      tips:'صدرك لفوق وركبتيك تتبع اصابعك، انزل لحد الموازي او اقل.' },
  { id:39, name:'Leg Press',                 name_ar:'ليج بريس',                muscle_group:'Legs',      difficulty:'beginner',     equipment:'Leg Press Machine',        tips:'رجليك بعرض الكتفين ومتقفلش ركبتيك في الاعلى.' },
  ...
  { id:41, name:'Leg Curl',                  name_ar:'كيرل همسترينج',           muscle_group:'Legs',      difficulty:'beginner',     equipment:'Leg Curl Machine',         tips:'مد كامل في البداية واضغط الهامسترينج كويس في الاعلى.' },
  { id:42, name:'Leg Extension',             name_ar:'ليج اكستنشن',             muscle_group:'Legs',      difficulty:'beginner',     equipment:'Leg Extension Machine',    tips:'اضغط الكوادريسبس في الاعلى وارجع ببطء.' },
  { id:43, name:'Lunge',                     name_ar:'لانج',                    muscle_group:'Legs',      difficulty:'beginner',     equipment:'Bodyweight / Dumbbells',   tips:'ركبتك الامامية فوق كاحلك وجسمك منتصب.' },
  { id:44, name:'Bulgarian Split Squat',     name_ar:'سبليت سكوات بلغاري',     muscle_group:'Legs',      difficulty:'intermediate', equipment:'Bench, Dumbbells',         tips:'الركبة ماتعدش الاصابع وادفع من الكعب.' },
  { id:45, name:'Hack Squat',                name_ar:'هاك سكوات',               muscle_group:'Legs',      difficulty:'intermediate', equipment:'Hack Squat Machine',       tips:'لو رجليك فوق بيشتغل على الارداف، لو تحت على الكواد.' },
  ...
  { id:47, name:'Hip Thrust',                name_ar:'هيب ثراست',               muscle_group:'Glutes',    difficulty:'beginner',     equipment:'Barbell, Bench',           tips:'اضغط الارداف بقوة في الاعلى وخلي دقنك في صدرك.' },
  ...
  { id:53, name:'Hanging Leg Raise',         name_ar:'رفع ارجل معلق',           muscle_group:'Abs',       difficulty:'intermediate', equipment:'Pull-Up Bar',              tips:'ماتهزش جسمك وحاول تلف الحوض للخلف في الاعلى.' },
  ...
  { id:55, name:'Russian Twist',             name_ar:'راشن تويست',              muscle_group:'Abs',       difficulty:'beginner',     equipment:'Bodyweight / Plate',       tips:'ارفع رجليك للصعوبة اكتر وتحرك ببطء.' },
  { id:56, name:'Ab Wheel Rollout',          name_ar:'اب ويل',                  muscle_group:'Abs',       difficulty:'advanced',     equipment:'Ab Wheel',                 tips:'ماتخليش ضهرك ينهار وشد بطنك طول الوقت.' },
  ...
  { id:59, name:'Standing Calf Raise',       name_ar:'رفع سمانة واقف',          muscle_group:'Calves',    difficulty:'beginner',     equipment:'Machine / Bodyweight',     tips:'مد كامل في الاسفل واضغط السمانة في الاعلى وارجع ببطء.' },
  { id:60, name:'Seated Calf Raise',         name_ar:'رفع سمانة جالس',          muscle_group:'Calves',    difficulty:'beginner',     equipment:'Seated Calf Machine',      tips:'الركبة المثنية بتشتغل على عضلة السولياس اكتر.' },
  ...
  { id:62, name:'Wrist Curl',                name_ar:'كيرل معصم',               muscle_group:'Forearms',  difficulty:'beginner',     equipment:'Barbell / Dumbbell',       tips:'مدى حركة كامل وتحرك ببطء.' },
  ...
  { id:64, name:'Farmers Walk',              name_ar:'مشية الفارمر',            muscle_group:'Forearms',  difficulty:'beginner',     equipment:'Dumbbells / Kettlebells',  tips:'خلي كتفيك ثابتين وامشي بثقة.' },
];
