    ...
    days_detail: [
      {
        day: 'اليوم الأول',
        exercises: [
          { name: 'سكوات', detail: '3 سيتات × 8 رباعات', exId: 35 },
          { name: 'بنش برس', detail: '3 سيتات × 8 رباعات', exId: 1 },
          { name: 'لات بول داون', detail: '3 سيتات × 10 رباعات', exId: 10 },
          { name: 'ضغط كتف', detail: '3 سيتات × 10 رباعات', exId: 15 },
          { name: 'كيرل كيبل', detail: '3 سيتات × 12 رباعة', exId: 26 },
          { name: 'تراسبس بوش داون', detail: '3 سيتات × 12 رباعة', exId: 31 },
        ],
      },
      {
        day: 'اليوم الثاني',
        exercises: [
          { name: 'رومانيان ديد ليفت', detail: '3 سيتات × 8 رباعات', exId: 37 },
          { name: 'ضغط دمبل مائل', detail: '3 سيتات × 10 رباعات', exId: 2 },
          { name: 'رووينج كيبل جالس', detail: '3 سيتات × 10 رباعات', exId: 11 },
          { name: 'ليج بريس', detail: '3 سيتات × 12 رباعة', exId: 36 },
          { name: 'رفع جانبي', detail: '3 سيتات × 15 رباعة', exId: 16 },
          { name: 'هامر كيرل', detail: '3 سيتات × 12 رباعة', exId: 23 },
        ],
      },
      {
        day: 'اليوم الثالث',
        exercises: [
          { name: 'ديد ليفت', detail: '3 سيتات × 5 رباعات', exId: 7 },
          { name: 'ماكينة ضغط الصدر', detail: '3 سيتات × 10 رباعات', exId: null },
          { name: 'عقلة', detail: '3 سيتات × بقصاك', exId: 8 },
          { name: 'سبليت سكوات بلغاري', detail: '3 سيتات × 10 رباعات', exId: 41 },
          { name: 'فيس بول', detail: '3 سيتات × 15 رباعة', exId: 13 },
          { name: 'تراسبس بوش داون حبل', detail: '3 سيتات × 12 رباعة', exId: 31 },
        ],
      },
    ],
  },
    ...
    days_detail: [
      {
        day: 'Upper 1',
        exercises: [
          { name: 'بنش برس', detail: '4 سيتات × 8 رباعات', exId: 1 },
          { name: 'رووينج بار', detail: '4 سيتات × 8 رباعات', exId: 9 },
          { name: 'ضغط دمبل مائل', detail: '3 سيتات × 10 رباعات', exId: 2 },
          { name: 'لات بول داون', detail: '3 سيتات × 10 رباعات', exId: 10 },
          { name: 'رفع جانبي', detail: '3 سيتات × 15 رباعة', exId: 16 },
          { name: 'تراسبس بوش داون', detail: '3 سيتات × 12 رباعة', exId: 31 },
      ...
      },
      {
        day: 'Lower 1',
        exercises: [
          { name: 'سكوات', detail: '4 سيتات × 8 رباعات', exId: 35 },
          { name: 'رومانيان ديد ليفت', detail: '3 سيتات × 10 رباعات', exId: 37 },
          { name: 'ليج بريس', detail: '3 سيتات × 12 رباعة', exId: 36 },
          { name: 'كيرل همسترينج', detail: '3 سيتات × 12 رباعة', exId: 38 },
          { name: 'رفع سمانة واقف', detail: '4 سيتات × 20 رباعة', exId: 56 },
          { name: 'رفع أرجل معلق', detail: '3 سيتات × 15 رباعة', exId: 50 },
        ],
      },
      {
        day: 'Upper 2',
        exercises: [
          { name: 'ضغط بنش مائل', detail: '4 سيتات × 8 رباعات', exId: 2 },
          { name: 'رووينج كيبل جالس', detail: '3 سيتات × 10 رباعات', exId: 11 },
          { name: 'ضغط كتف', detail: '3 سيتات × 10 رباعات', exId: 15 },
          { name: 'عقلة', detail: '3 سيتات × بقصاك', exId: 8 },
          { name: 'فيس بول', detail: '3 سيتات × 15 رباعة', exId: 13 },
          { name: 'هامر كيرل', detail: '3 سيتات × 12 رباعة', exId: 23 },
          { name: 'سكال كراشر', detail: '3 سيتات × 12 رباعة', exId: 30 },
        ],
      },
      {
        day: 'Lower 2',
        exercises: [
          { name: 'ديد ليفت', detail: '4 سيتات × 5 رباعات', exId: 7 },
          { name: 'سبليت سكوات بلغاري', detail: '3 سيتات × 10 رباعات', exId: 41 },
          { name: 'ليج اكستنشن', detail: '3 سيتات × 15 رباعة', exId: 39 },
          { name: 'كيرل همسترينج', detail: '3 سيتات × 12 رباعة', exId: 38 },
          { name: 'رفع سمانة جالس', detail: '4 سيتات × 20 رباعة', exId: 57 },
          { name: 'كرانش كيبل', detail: '3 سيتات × 15 رباعة', exId: 51 },
        ],
      },
    ],
  },
    ...
    days_detail: [
      {
        ...
        exercises: [
          { name: 'بنش برس', detail: '4 سيتات × 6-8 رباعات', exId: 1 },
          { name: 'ضغط دمبل مائل', detail: '3 سيتات × 10 رباعات', exId: 2 },
          { name: 'ماكينة ضغط الصدر', detail: '3 سيتات × 12 رباعة', exId: null },
          { name: 'ضغط كتف', detail: '3 سيتات × 10 رباعات', exId: 15 },
          { name: 'رفع جانبي', detail: '3 سيتات × 15 رباعة', exId: 16 },
          { name: 'تراسبس بوش داون', detail: '3 سيتات × 12 رباعة', exId: 31 },
          { name: 'مط تراسبس فوق الرأس', detail: '3 سيتات × 12 رباعة', exId: 32 },
        ],
      },
      {
        day: 'Pull A (ظهر - باي)',
        exercises: [
          { name: 'ديد ليفت', detail: '4 سيتات × 5 رباعات', exId: 7 },
          { name: 'عقلة', detail: '4 سيتات × بقصاك', exId: 8 },
          { name: 'رووينج بار', detail: '3 سيتات × 8 رباعات', exId: 9 },
          { name: 'لات بول داون', detail: '3 سيتات × 12 رباعة', exId: 10 },
          { name: 'فيس بول', detail: '3 سيتات × 15 رباعة', exId: 13 },
          { name: 'كيرل بار', detail: '3 سيتات × 10 رباعات', exId: 21 },
          { name: 'هامر كيرل', detail: '3 سيتات × 12 رباعة', exId: 23 },
        ],
      },
      {
        day: 'Legs A',
        exercises: [
          { name: 'سكوات', detail: '4 سيتات × 6-8 رباعات', exId: 35 },
          { name: 'ليج بريس', detail: '3 سيتات × 12 رباعة', exId: 36 },
          { name: 'رومانيان ديد ليفت', detail: '3 سيتات × 10 رباعات', exId: 37 },
          { name: 'ليج اكستنشن', detail: '3 سيتات × 15 رباعة', exId: 39 },
          { name: 'كيرل همسترينج', detail: '3 سيتات × 12 رباعة', exId: 38 },
      ...
      },
      {
        ...
        exercises: [
          { name: 'ضغط بنش مائل', detail: '4 سيتات × 8 رباعات', exId: 2 },
          { name: 'دبس الصدر', detail: '3 سيتات × 10 رباعات', exId: 6 },
          { name: 'بيك ديك فلاي', detail: '3 سيتات × 15 رباعة', exId: null },
          { name: 'ضغط أرنولد', detail: '3 سيتات × 10 رباعات', exId: 19 },
          { name: 'رفع جانبي كيبل', detail: '3 سيتات × 15 رباعة', exId: 16 },
          { name: 'سكال كراشر', detail: '3 سيتات × 10 رباعات', exId: 30 },
          { name: 'تراسبس بوش داون حبل', detail: '3 سيتات × 12 رباعة', exId: 31 },
        ],
      },
      {
        day: 'Pull B',
        exercises: [
          { name: 'رووينج مسنود على الصدر', detail: '3 سيتات × 10 رباعات', exId: null },
          { name: 'لات بول داون قبضة ضيقة', detail: '3 سيتات × 12 رباعة', exId: 10 },
          { name: 'رووينج كيبل جالس', detail: '3 سيتات × 12 رباعة', exId: 11 },
          { name: 'رفع خلفي للكتف', detail: '3 سيتات × 15 رباعة', exId: 18 },
          { name: 'كيرل بار EZ', detail: '3 سيتات × 10 رباعات', exId: 21 },
          { name: 'بريتشر كيرل', detail: '3 سيتات × 12 رباعة', exId: 24 },
        ],
      },
      {
        day: 'Legs B',
        exercises: [
          { name: 'سكوات أمامي', detail: '3 سيتات × 8 رباعات', exId: 43 },
          { name: 'هاك سكوات', detail: '3 سيتات × 10 رباعات', exId: 42 },
          { name: 'سبليت سكوات بلغاري', detail: '3 سيتات × 10 رباعات', exId: 41 },
          { name: 'كيرل همسترينج جالس', detail: '3 سيتات × 12 رباعة', exId: 38 },
          { name: 'رفع سمانة', detail: '4 سيتات × 20 رباعة', exId: 56 },
          { name: 'دائرة تمارين بطن', detail: '3 سيتات', exId: null },
        ],
      },
    ],
  },
  {
    ...
    days_detail: [
      ...
      },
      {
        day: 'Shoulders + Arms',
        exercises: [
          { name: 'ضغط كتف', detail: '4 سيتات × 8 رباعات', exId: 15 },
          { name: 'رفع جانبي', detail: '3 سيتات × 15 رباعة', exId: 16 },
          { name: 'رفع خلفي للكتف', detail: '3 سيتات × 15 رباعة', exId: 18 },
          { name: 'كيرل بار', detail: '3 سيتات × 10 رباعات', exId: 21 },
          { name: 'هامر كيرل', detail: '3 سيتات × 12 رباعة', exId: 23 },
    ...
    days_detail: [
      {
        ...
        exercises: [
          { name: 'بنش برس', detail: '4 سيتات × 8 رباعات', exId: 1 },
          { name: 'ضغط دمبل مائل', detail: '3 سيتات × 10 رباعات', exId: 2 },
          { name: 'فلاي دمبل', detail: '3 سيتات × 15 رباعة', exId: 5 },
          { name: 'دبس الصدر', detail: '3 سيتات × 12 رباعة', exId: 6 },
        ],
      },
      {
        day: 'Day 2 - Back',
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'رفع جانبي', detail: '3 سيتات × 15 رباعة', exId: 16 },
          { name: 'رفع خلفي للكتف', detail: '3 سيتات × 15 رباعة', exId: 18 },
          { name: 'رووينج عمودي', detail: '3 سيتات × 12 رباعة', exId: 20 },
        ],
      },
      {
        day: 'Day 4 - Arms',
